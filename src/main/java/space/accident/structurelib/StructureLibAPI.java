...
import static space.accident.structurelib.StructureLib.proxy;
...
public class StructureLibAPI {
     ...
     * <p>
     * You don't need to call this unless your constructable tool didn't call {@link ConstructableUtility#handle(ItemStack, EntityPlayer, World, int, int, int, int)}
     */
     ...
     * The ExtendedFacing will later be set onto given tile entity via {@link IAlignment#setExtendedFacing(ExtendedFacing)}
